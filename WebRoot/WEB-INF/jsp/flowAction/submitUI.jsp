...
<!--显示表单内容-->
<div id=MainArea>
    <s:form action="flowAcion_submit" enctype="multipart/form-data">
            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
					<tr>
						...
						<s:a action="applicationTemplateAction_download?id=%{applicationTemplateId}" cssStyle="text-decoration: underline">[点击下载文档模板文件]</s:a>
